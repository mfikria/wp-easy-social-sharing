	...
	if(is_home() || is_singular()) {
		...
		if(get_option("wess_facebook") == 1) {
			...
			<li class="wess-buttons__facebook">
				<a target="popup" onclick=\'window.open("' . $fb_share_url . '","name","width=600,height=400")\' >
					<i class="socicon-facebook"></i>
					<span class="wess-buttons__count"> ' . $facebook_share_count . ' </span>
				</a>
			</li>';
			...
			<li class="wess-buttons-mobile__facebook">
				<a href="' . $fb_share_url . '" rel="nofollow">
					<i class="socicon-facebook"></i>
					<span class="wess-buttons-mobile__title">Facebook</span>
					<span class="wess-buttons-mobile__count">' . $facebook_share_count . '</span>
				</a>
			</li>';
		}
		...
		if(get_option("wess_twitter") == 1) {
			...
			<li class="wess-buttons__twitter">
				<a target="popup" onclick=\'window.open("' . $twitter_share_url . '","name","width=600,height=400")\'>
					<i class="socicon-twitter"></i>
					<span class="wess-buttons__count">~</span>
				</a>
			</li>';
			...
			<li class="wess-buttons-mobile__twitter">
				<a href="'. $twitter_share_url . '" rel="nofollow">
					<i class="socicon-twitter"></i>
					<span class="wess-buttons-mobile__title">Twitter</span>
					<span class="wess-buttons-mobile__count">~</span>
				</a>
			</li>';
		}
		...
		if(get_option("wess_linkedin") == 1){
			...
			<li class="wess-buttons__linkedin">
				<a target="popup" onclick=\'window.open("' . $linkedin_share_url . '","name","width=600,height=400")\'>
					<i class="socicon-linkedin"></i>
					<span class="wess-buttons__count"> ' . $linkedin_share_count . ' </span>
				</a>
			</li>';
			...
			<li class="wess-buttons-mobile__linkedin">
				<a href="' . $linkedin_share_url . '" rel="nofollow">
					<i class="socicon-linkedin"></i>
					<span class="wess-buttons-mobile__title">LinkedIn</span>
					<span class="wess-buttons-mobile__count">' . $linkedin_share_count . '</span>
				</a>
			</li>';
		}
...
// style
function wess_style() {
	wp_register_style('wess_style', WESS_URI . 'style.css', array(), null, false);
	wp_enqueue_style('wess_style');
}
...
function wess_scripts_basic() {
	wp_register_script( 'wess_script', WESS_URI . 'assets/js/script.js', array(), null, false);
